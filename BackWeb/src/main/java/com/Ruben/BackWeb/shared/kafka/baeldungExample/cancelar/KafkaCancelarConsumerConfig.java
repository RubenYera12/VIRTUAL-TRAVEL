//package com.Ruben.BackWeb.shared.kafka.baeldungExample.cancelar;
//
...
//
//    @KafkaListener(topics = "CANCELAR_RESERVA_FROM_EMPRESA", groupId = "BackEmpresa")
//    public void listenGroupFoo(String message){
//        try {
//            System.out.println(message);
//            reservaService.deleteById(message);//La borramos ya que no nos hace falta
//        }catch (Exception e){
//            e.printStackTrace();
//        }
